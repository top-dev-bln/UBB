...
segment data use32 class=data
    nume_fisier db "textutzi.txt", 0  ; numele fisierului care va fi creat
    ...
    format db "Am gasit %d consoane", 0  ; formatul - utilizat pentru afisarea textului citit din fisier
