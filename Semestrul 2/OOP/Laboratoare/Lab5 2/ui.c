...
void Ruleaza_Meniu()
{
	...
	while (1)
	{
		...
		case 'vrajeala':
		{
			printf("Facem sortarea dupa pretz ");
			break;
		}
		case '4':
...
void Adauga_Valori_Repo(Controller* ctrl)
{
	...
	Adauga_Oferta_Controller(ctrl, "teren", 90, "strada7", 300);
	Adauga_Oferta_Controller(ctrl, "teren", 100, "strada8", 400);
	Adauga_Oferta_Controller(ctrl, "teren", 110, "strada9", 500);
	Adauga_Oferta_Controller(ctrl, "teren", 120, "strada10", 600);
	Adauga_Oferta_Controller(ctrl, "teren", 130, "strada11", 700);
	Adauga_Oferta_Controller(ctrl, "teren", 140, "strada12", 800);
